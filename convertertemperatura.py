# Programa para converter temperaturas de grau Celsius, Fahrenheit e Kelvin
...
origem = input("Informe qual a unidade de origem (C, F, K): ").upper()
destino = input("Informe qual a unidade para conversão (C, F, K): ").upper()
